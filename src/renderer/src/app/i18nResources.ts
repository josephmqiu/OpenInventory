...
const baseI18nResources = {
  en: {
    common: {
      ...
      language: "Language",
      currency: "Currency",
      currencyHint: "Used to display item prices and total inventory value.",
      currencyChangeWarning: "Existing prices keep their numbers; only the currency label changes.",
      ...
      lanOpenOnDevice: "QR Lookup Page",
      ...
      lanUrlsUnavailable: "Enable LAN access to see QR lookup URLs.",
      lanInventoryLookupQr: "Inventory Lookup QR",
      lanInventoryLookupQrHint: "Post this code so staff can browse the catalog (read-only). No item scan needed.",
      lanCopy: "Copy",
    ...
    inventory: {
      ...
      severity: "Severity",
      priceOptionalHint: "Optional — leave blank if unknown",
      priceInvalid: "Enter a valid price (e.g. 12.50).",
      totalInventoryValue: "Total Value",
      pricedCoverage: "{priced} of {total} items priced",
    ...
    audit: {
      ...
      reports: "Reports",
      reportsHint: "Executive period summary — pick a period to review inventory movements, value, and trends.",
      periodSummary: "Period Summary",
      periodGranularity: "Period",
      granularity_month: "Month",
      granularity_quarter: "Quarter",
      granularity_half: "Half-year",
      granularity_year: "Year",
      prevPeriod: "Previous period",
      nextPeriod: "Next period",
      generatedOn: "Generated {datetime}",
      dateRange: "Date Range",
      currencyLabel: "Currency",
      valuedAtCurrentPrices: "Values shown at current prices.",
      unpricedExcluded: "Value excludes {excluded} of {total} unpriced items.",
      issuedValue: "Value Issued",
      receivedValue: "Value Received",
      netValue: "Net Value",
      inventoryHealth: "Items Hit Low/Zero",
      issuedQty: "Issued (qty)",
      yoyLabel: "YoY {text}",
      noPriorYearData: "no prior-year data",
      trendTitle: "Issued value — last 6 periods",
      biggestMoversTitle: "What moved most vs {label}",
      noPriorPeriod: "No prior period to compare.",
      topItemsTitle: "Top items by issued value",
      noMovementInPeriod: "No inventory movement in {period}.",
      print: "Print",
      metric: "Metric",
      value: "Value",
    },
    quickIssue: {
      ...
      itemsShown: "{count, plural, one {# item} other {# items}}",
      noItemsInInventory: "No items in inventory yet.",
  ...
  "zh-CN": {
    common: {
      ...
      language: "语言",
      currency: "货币",
      currencyHint: "用于显示物料价格和库存总值。",
      currencyChangeWarning: "现有价格的数字保持不变，仅货币标签改变。",
      ...
      lanUrlsUnavailable: "启用 LAN 访问后即可查看二维码查询链接。",
      lanInventoryLookupQr: "库存查询二维码",
      lanInventoryLookupQrHint: "张贴此二维码，员工无需扫描单个物料即可只读浏览库存目录。",
      lanCopy: "复制",
    ...
    inventory: {
      ...
      moveColumnRight: "右移",
      severity: "严重程度",
      priceOptionalHint: "选填 — 未知可留空",
      priceInvalid: "请输入有效价格（例如 12.50）。",
      totalInventoryValue: "库存总值",
      pricedCoverage: "{total} 项中 {priced} 项已定价",
      createItem: "新增物料",
      modifyItem: "修改物料",
      receiveStock: "入库",
      issueMaterial: "出库",
    ...
    audit: {
      ...
      goToInventory: "前往库存",
      reports: "报表",
      reportsHint: "管理层周期摘要——选择周期以查看库存变动、价值与趋势。",
      periodSummary: "周期摘要",
      periodGranularity: "周期",
      granularity_month: "月",
      ...
      prevPeriod: "上一周期",
      nextPeriod: "下一周期",
      generatedOn: "生成于 {datetime}",
      dateRange: "日期范围",
      currencyLabel: "货币",
      valuedAtCurrentPrices: "数值按当前价格计算。",
      unpricedExcluded: "价值不含 {total} 项中的 {excluded} 项未定价物料。",
      issuedValue: "出库价值",
      receivedValue: "入库价值",
      netValue: "净价值",
      inventoryHealth: "触及低/零库存的物料",
      issuedQty: "出库（数量）",
      yoyLabel: "同比 {text}",
      noPriorYearData: "无去年同期数据",
      trendTitle: "出库价值——近 6 个周期",
      biggestMoversTitle: "相较 {label} 变动最大",
      noPriorPeriod: "无可比较的上一周期。",
      topItemsTitle: "出库价值排名前列物料",
      noMovementInPeriod: "{period} 无库存变动。",
      print: "打印",
      metric: "指标",
      value: "数值",
    },
    quickIssue: {
      ...
      itemsShown: "{count, plural, other {# 项物料}}",
      noItemsInInventory: "库存中暂无物料。",
      noItemsMatchFilter: "没有符合此筛选条件的物料。",
      showAll: "显示全部",
      loadingInventory: "正在加载库存…",
      unableToLoadInventory: "无法加载库存。",
    },
    errors: {
